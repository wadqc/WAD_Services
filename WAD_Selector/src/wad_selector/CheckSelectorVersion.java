 ...
 */
public class CheckSelectorVersion {
    private static Log log = LogFactory.getLog(CheckSelectorVersion.class);
    ...
    public void CheckVersion(Connection iqcConnection, String version){
        ...
        try {
            ...
            passedCheck = true;
                ...
                log.info("Selector versie:"+version);
            } else {
                log.fatal("Database major versie: "+dbVersion+" komt niet overeen met Selector major versie:"+version);
                log.fatal("Selector wordt niet gestart");
            }
    ...
    public static void UpdateVersion(Connection dbConnection, String version){
        ...
        String sqlStatement = "UPDATE config SET value='"+version+"', date_modified='"+dateFormat.format(date)+"'  WHERE property='Version_Selector'";            
